...
public class LoanAgainstProperty extends JFrame
{
	...
	JLabel headingJLabel = new JLabel("Loan Against Property Application");
	...
	public LoanAgainstProperty()
	{
		setSize(1150, 650);
		setTitle("DSD BANK - Loan Against Property");
		setLayout(null);
		setLocation(200, 100);
		...
		add(headingJLabel);
		headingJLabel.setBounds(430, 10, 410, 27);
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						if (rs1.next())
						{
							...
							{
								JOptionPane.showMessageDialog(LoanAgainstProperty.this, "Mobile Number is Verified");
								...
								JOptionPane.showMessageDialog(LoanAgainstProperty.this, "Entered Mobile Number is Not Linked To Your Account");
							}
						} else {
							JOptionPane.showMessageDialog(LoanAgainstProperty.this, "Invalid Account Number");
						}
					} catch (Exception e2) {
						e2.printStackTrace();
					}
							...
							public void actionPerformed(ActionEvent e) {
								...
								try {
									...
									if (rs.next())
									{
										...
										{
											JOptionPane.showMessageDialog(LoanAgainstProperty.this, "Email ID is Verified");
											verifyEmailIdJButton.setBackground(Color.GREEN);
											verifyEmailIdJButton.setText("Verified");
											emailJTextField.setEditable(false);
										} else {
											JOptionPane.showMessageDialog(LoanAgainstProperty.this, "This Email is Not Linked to Your Account");
										}
									} else {
										JOptionPane.showMessageDialog(LoanAgainstProperty.this, "Invalid Account Number");
									}
						...
						nextJButton.addActionListener(new ActionListener() {
							...
							public void actionPerformed(ActionEvent e) {
								...
								if (verifyEmailIdJButton.getText()=="Verified" && verifyMobileNoJButton.getText()=="Verified")
								{
									  ...
									  String typeOfLoan = "Laon Against Property";
									  ...
									  try {
							              ...
							              PreparedStatement ps3 = con.prepareStatement("Insert into LOANAPROPERTYDOCUMENTS values(?,?,?,?,?,?,?,?,?,?)");
										  ...
										  if (rs1.next())
										  {
											...
											if (/* firstName!=null && */ F_name.equals(middleName) /* && surName!=null */)
											{
												...
												if (i==1 && k==1) 
												{
													JOptionPane.showMessageDialog(LoanAgainstProperty.this, "Personal Detials for Loan Appliction is Saved Successfully");
													
												} else {
													JOptionPane.showMessageDialog(LoanAgainstProperty.this, "Unable to save the Data "+"\nPlease check the detials");
												}
											} else {
												JOptionPane.showMessageDialog(LoanAgainstProperty.this, "Enter the Correct NAME as Per PassBook");
											}
										  } else {
											  JOptionPane.showMessageDialog(LoanAgainstProperty.this, "Invalid Account Number");
									      }  
									...
									JOptionPane.showMessageDialog(LoanAgainstProperty.this, "Verify the"+"\nEmail Address and"+"\nMobile Number");
								}
							}
						});
	...
	{
		LoanAgainstProperty loanAgainstProperty = new LoanAgainstProperty();
		loanAgainstProperty.setVisible(true);
		loanAgainstProperty.setResizable(false);
	}
}
