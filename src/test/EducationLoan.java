...
public class EducationLoan extends JFrame
{
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						if (rs1.next())
						{
							...
							{
								JOptionPane.showMessageDialog(EducationLoan.this, "Mobile Number is Verified");
								...
								JOptionPane.showMessageDialog(EducationLoan.this, "Entered Mobile Number is Not Linked To Your Account");
							}
						} else {
							JOptionPane.showMessageDialog(EducationLoan.this, "Invalid Account Number");
						}
					} catch (Exception e2) {
						e2.printStackTrace();
					}
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						if (rs.next())
						{
							...
							{
								JOptionPane.showMessageDialog(EducationLoan.this, "Email ID is Verified");
								verifyEmailIdJButton.setBackground(Color.GREEN);
								verifyEmailIdJButton.setText("Verified");
								emailJTextField.setEditable(false);
							} else {
								JOptionPane.showMessageDialog(EducationLoan.this, "This Email is Not Linked to Your Account");
							}
						} else {
							JOptionPane.showMessageDialog(EducationLoan.this, "Invalid Account Number");
						}
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (verifyEmailIdJButton.getText()=="Verified" && verifyMobileNoJButton.getText()=="Verified")
					{
						  ...
						  try {
							  ...
							  PreparedStatement ps3 = con.prepareStatement("Insert into VECHICALLOANDOCUMENTS values(?,?,?,?,?,?,?,?,?,?)");
							  ...
							  if (rs1.next())
							  {
								...
								if (/* firstName!=null && */ F_name.equals(middleName) /* && surName!=null */)
								{
									...
									if (i==1 && k==1) 
									{
										JOptionPane.showMessageDialog(EducationLoan.this, "Personal Detials for Loan Appliction is Saved Successfully");
									} else {
										JOptionPane.showMessageDialog(EducationLoan.this, "Unable to save the Data "+"\nPlease check the detials");
									}
								} else {
									JOptionPane.showMessageDialog(EducationLoan.this, "Enter the Correct NAME as Per PassBook");
								}
							  } else {
								  JOptionPane.showMessageDialog(EducationLoan.this, "Invalid Account Number");
						      }  
						...
						JOptionPane.showMessageDialog(EducationLoan.this, "Verify the"+"\nEmail Address and"+"\nMobile Number");
					}
				}
			});
	...
	public static void main(String[] args)
	{
		...
		educationLoan.setVisible(true);
		educationLoan.setResizable(false);
	}
}
