...
public class HomeLoan extends JFrame
{
	...
	JLabel headingJLabel = new JLabel("Home Loan Application");
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						if (rs1.next())
						{
							...
							{
								JOptionPane.showMessageDialog(HomeLoan.this, "Mobile Number is Verified");
								...
								JOptionPane.showMessageDialog(HomeLoan.this, "Entered Mobile Number is Not Linked To Your Account");
							}
						} else {
							JOptionPane.showMessageDialog(HomeLoan.this, "Invalid Account Number");
						}
					} catch (Exception e2) {
						e2.printStackTrace();
					}
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						if (rs.next())
						{
							...
							{
								JOptionPane.showMessageDialog(HomeLoan.this, "Email ID is Verified");
								verifyEmailIdJButton.setBackground(Color.GREEN);
								verifyEmailIdJButton.setText("Verified");
								emailJTextField.setEditable(false);
							} else {
								JOptionPane.showMessageDialog(HomeLoan.this, "This Email is Not Linked to Your Account");
							}
						} else {
							JOptionPane.showMessageDialog(HomeLoan.this, "Invalid Account Number");
						}
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (verifyEmailIdJButton.getText()=="Verified" && verifyMobileNoJButton.getText()=="Verified")
					{
						  ...
						  try {
							  ...
							  PreparedStatement ps3 = con.prepareStatement("Insert into HOMELOANDOCUMENTS values(?,?,?,?,?,?,?,?,?,?)");
							  ...
							  if (rs1.next())
							  {
								...
								if (/* firstName!=null && */ F_name.equals(middleName) /* && surName!=null */)
								{
									...
									if (i==1 && k==1) 
									{
										JOptionPane.showMessageDialog(HomeLoan.this, "Personal Detials for Loan Appliction is Saved Successfully");
										new HomeLoan2().setVisible(true);
										setVisible(false);
									} else {
										JOptionPane.showMessageDialog(HomeLoan.this, "Unable to save the Data "+"\nPlease check the detials");
									}
								} else {
									JOptionPane.showMessageDialog(HomeLoan.this, "Enter the Correct NAME as Per PassBook");
								}
							  } else {
								  JOptionPane.showMessageDialog(HomeLoan.this, "Invalid Account Number");
						      }  
						...
						JOptionPane.showMessageDialog(HomeLoan.this, "Verify the"+"\nEmail Address and"+"\nMobile Number");
					}
				}
			});
	...
	public static void main(String[] args) 
	{
		...
		homeLoan.setVisible(true);
		homeLoan.setResizable(false);
	}
}
