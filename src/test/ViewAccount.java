...
public class ViewAccount extends JFrame
{
	...
	public ViewAccount()
	{
		...
		enterAccountNoJLabel.setBounds(847, 15, 120, 20);
		...
		enterAccountNoJTextField.setToolTipText("Enter Account Number");	
		...
		add(mobileNoJLabel);
		mobileNoJLabel.setBounds(420, 200, 60, 15);
				...
				long accountNo = Long.parseLong(enterAccountNoJTextField.getText());
					...
					try {
						...
						if (rs1.next() && rs2.next() && rs3.next() && rs4.next())
						{
							...
							JOptionPane.showMessageDialog(ViewAccount.this, "Invalid Account Number"+"\n Please check the account number and re-enter it");
						}
					} catch (Exception e2) {
						e2.printStackTrace();
					}
	...
	public static void main(String[] args)
	{
		...
		viewAccount.setResizable(false);
	}
}
