...
public class PersonalLoan extends JFrame
{
	...
	JLabel headingJLabel = new JLabel("Personal Loan Application");
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (rs1.next())
					{
						...
						{
							JOptionPane.showMessageDialog(PersonalLoan.this, "Mobile Number is Verified");
							...
							JOptionPane.showMessageDialog(PersonalLoan.this, "Entered Mobile Number is Not Linked To Your Account");
						}
					} else {
						JOptionPane.showMessageDialog(PersonalLoan.this, "Invalid Account Number");
					}
				} catch (Exception e2) {
					e2.printStackTrace();
				}
						...
						public void actionPerformed(ActionEvent e) {
							...
							try {
								...
								if (rs.next())
								{
									...
									{
										JOptionPane.showMessageDialog(PersonalLoan.this, "Email ID is Verified");
										verifyEmailIdJButton.setBackground(Color.GREEN);
										verifyEmailIdJButton.setText("Verified");
										emailJTextField.setEditable(false);
									} else {
										JOptionPane.showMessageDialog(PersonalLoan.this, "This Email is Not Linked to Your Account");
									}
								} else {
									JOptionPane.showMessageDialog(PersonalLoan.this, "Invalid Account Number");
								}
		...
		nextJButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (verifyEmailIdJButton.getText()=="Verified" && verifyMobileNoJButton.getText()=="Verified")
				{
					  ...
					  String typeOfLoan = "Personal Laon";
					  ...
					  try {
						  ...
						  PreparedStatement ps3 = con.prepareStatement("Insert into PERSONALLOANDOCUMENTS values(?,?,?,?,?,?,?,?)");
						  ...
						  if (rs1.next())
						  {
							...
							if (/* firstName!=null && */ F_name.equals(middleName) /* && surName!=null */)
							{
								...
								if (i==1 && k==1) 
								{
									JOptionPane.showMessageDialog(PersonalLoan.this, "Personal Detials for Loan Appliction is Saved Successfully");
									new PersonalLoan2().setVisible(true);
									setVisible(false);
								} else {
									JOptionPane.showMessageDialog(PersonalLoan.this, "Unable to save the Data "+"\nPlease check the detials");
								}
							} else {
								JOptionPane.showMessageDialog(PersonalLoan.this, "Enter the Correct NAME as Per PassBook");
							}
						  } else {
							  JOptionPane.showMessageDialog(PersonalLoan.this, "Invalid Account Number");
					      }  
					...
					JOptionPane.showMessageDialog(PersonalLoan.this, "Verify the"+"\nEmail Address and"+"\nMobile Number");
				}
			}
		});
	...
	public static void main(String[] args)
	{
		...
		personalLoan.setVisible(true);
		personalLoan.setResizable(false);
	}
}
